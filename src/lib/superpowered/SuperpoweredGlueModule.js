...
class SuperpoweredGlue {
    ...
    static registerMemoryUsageListener(listener) {
        console.log('regiseing listener');
    ...
    logMemory() {
        const message = 'WASM memory ' + this.id + ': ' + this.niceSize(this.__functions__.__stacksize__()) + ' stack, ' + this.niceSize(this.linearMemory.byteLength - this.__functions__.__heapbase__()) + ' heap, ' + this.niceSize(this.linearMemory.byteLength) + ' total.';
        console.log(message);
        console.log(memoryUsageListener);
        if (memoryUsageListener) memoryUsageListener(message);
    }
